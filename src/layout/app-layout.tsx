...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin-user', 'data-analyst', 'political-strategist', 'campaign-manager', 'volunteer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Voter', path: '/voters', entity: 'voter', service: AccessServiceEnum.PROJECT, icon: FiThumbsUp },
